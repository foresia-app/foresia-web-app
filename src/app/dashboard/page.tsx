...
export default function Page() {
  return (
    <div className="[--header-height:calc(--spacing(14))] bg-green-50 min-h-screen">
          ...
          <SidebarInset>
            <div className="flex flex-1 flex-col gap-6 p-6">
              ...
              <div className="space-y-2">
                <h1 className="text-3xl font-bold text-gray-900">Welkom terug, Alex!</h1>
                <p className="text-gray-600">Hier is je dagelijkse overzicht van de school activiteiten.</p>
              </div>
